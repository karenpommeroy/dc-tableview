(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    define(["bootstrap","dc","jquery"], function (a0,b1,c2) {
      return (root['tableview'] = factory(a0,b1,c2));
    });
  } else if (typeof module === 'object' && module.exports) {
    // Node. Does not work with strict CommonJS, but
    // only CommonJS-like environments that support module.exports,
    // like Node.
    module.exports = factory(require("bootstrap"),require("dc"),require("jquery"));
  } else {
    root['tableview'] = factory(root["bootstrap"],root["dc"],root["$"]);
  }
}(this, function (bootstrap, dc, $) {
